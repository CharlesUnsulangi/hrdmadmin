...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $totalApplicants = DB::table('tr_hr_pelamar_interview')->count();
        $confirmedApplicants = DB::table('tr_hr_pelamar_interview')->whereNotNull('date_interview')->count();
        $todayInterviews = DB::table('tr_hr_pelamar_interview')->whereDate('date_interview', now()->toDateString())->count();
        $newEmployees = DB::table('ms_hr_kandidat')->whereNotNull('date_emp')->count();
        // Statistik per user HRD (leaderboard)
        $userStats = DB::table('tr_hr_pelamar_interview')
        ...
        $upcomingInterviews = DB::table('tr_hr_pelamar_interview')
