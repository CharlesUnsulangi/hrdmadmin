            ...
            @if(Auth::check())
                ...
                <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col min-h-screen">
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-2">
                        ...
                        <a href="{{ route('employee') }}" class="flex items-center px-3 py-2 rounded text-black hover:bg-blue-100">
                        ...
                        <a href="{{ url('/admin-it') }}" class="flex items-center px-3 py-2 rounded text-black hover:bg-blue-100">
                            <svg class="h-5 w-5 mr-2 text-cyan-700" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M8 19h8"/></svg>
                            Admin IT
                        </a>
