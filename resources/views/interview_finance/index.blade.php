...
<div class="container py-4">
    <h2>Daftar Interview Finance</h2>
    <a href="{{ route('interview_finance.create') }}" class="btn btn-success mb-3">Tambah Interview Finance</a>
    @if(session('success'))
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('interview_finance.edit', $row->tr_hr_pelamar_operator_id) }}" class="btn btn-sm btn-primary">Edit</a>
                </td>
            </tr>
            @endforeach
        </tbody>
