...
<div class="container py-4">
    <h2>Edit Interview HRD</h2>
    <form action="{{ route('interview_hrd.update', $interview->tr_hr_pelamar_operator_id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <a href="{{ route('interview_hrd.index') }}" class="btn btn-secondary">Batal</a>
    </form>
</div>
@endsection
