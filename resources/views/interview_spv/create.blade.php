...
<div class="container py-4">
    <h2>Tambah Interview Supervisor</h2>
    <form action="{{ route('interview_spv.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Set default time to now (rounded to nearest 5 minutes)
        ...
        <a href="{{ route('interview_spv.index') }}" class="btn btn-secondary">Batal</a>
    </form>
</div>
@endsection
