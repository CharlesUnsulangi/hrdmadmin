<div class="card border-danger">
    <div class="card-header bg-danger text-white">
        <h6 class="mb-0"><i class="fas fa-car-crash me-2"></i>Data Kecelakaan BA Laka (Edit Mode)</h6>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control @error('ms_truck_id') is-invalid @enderror" 
                       id="ms_truck_id" name="ms_truck_id" 
                       value="{{ old('ms_truck_id', $beritaAcara->laka->ms_truck_id ?? '') }}" 
            ...
            <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control @error('ms_driver_id') is-invalid @enderror" 
                       id="ms_driver_id" name="ms_driver_id" 
                       value="{{ old('ms_driver_id', $beritaAcara->laka->ms_driver_id ?? '') }}" 
            ...
            <div class="col-md-12 mb-3">
                ...
                <textarea class="form-control @error('note_kronologi') is-invalid @enderror" 
                          ...
                          placeholder="Deskripsikan kronologi kejadian secara detail...">{{ old('note_kronologi', $beritaAcara->laka->note_kronologi ?? '') }}</textarea>
                <div class="form-text">
